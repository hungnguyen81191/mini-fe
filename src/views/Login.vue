<template>
    <div class=" bgflex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form name="login" class="space-y-6" action="#" method="POST">
                <div>
                    ...
                    <div class="mt-2">
                        <input id="email" name="email" type="text" required v-model="userEmail"
                ...
                <div>
                    <button type="button" @click="loginFe(userEmail, userPassword)"
...
async function loginFe(email: string, password: string) {
